 ...
 * Частина 12. Додавання вузла на початок двозв’язного списку.
 *----------------------------------------------------------------
 * ITA17
 * Vaskivnyuk Mykhailo
 * 22.06.2017
...
/* ЗАВДАННЯ
Перепишіть процедуру AddFirst(), використовуючи виключно синтаксис С.
В списку вхідних параметрів тип змінних Head i Tail встановіть як покажчик на покажчик,
і в потрібних місцях тіла процедури забезпечте його розіменування.
*/
