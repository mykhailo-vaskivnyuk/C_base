 ...
 * Частина 10. Видалення вузла зі списку.
 *----------------------------------------------------------------
 * ITA17
 * Vaskivnyuk Mykhailo
 * 17.06.2017
...
/* ЗАВДАННЯ
Перепишіть процедуру DeleteNode, використовуючи виключно синтаксис С
і з врахуванням вимог до раніше написаних процедур AddFirst, AddBefore i AddLast
...
//------------------------------------------------------------------------------
    cls_delete_node(&clubs_ptr, &club_ptr);
    cls_delete_node(&clubs_ptr, &club_ptr_2);
    cls_delete_list(&clubs_ptr);
