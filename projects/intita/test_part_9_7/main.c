 ...
 * Частина 7. Звільнення динамічної пам’яті: функція free().
 *----------------------------------------------------------------
 * ITA17
 * Vaskivnyuk Mykhailo
 * 16.06.2017
...
2. Виділити динамічно пам'ять для масиву структур Club розмірністю n
   (не більше 10 елементів-клубів);
3. Заповнити масив стурктур даними про клуби (використовуючи покажчик
   на виділену в п. 2 область пам'яті).
4. Вивести дані про клуби на екран (за допомогою того самого покажчика).
5. Звільнити виділену під масив пам'ять і спробувати вивести масив структур
   на екран через покажчик.
6. На основі п.5 зробити висновок про необхідність або відсутність необхідності
   "обнуляти" покажчик після звільнення пам'яті.
*/
