 ...
 * Частина 4. Динамічне виділення пам’яті: функція malloc().
 *----------------------------------------------------------------
 * ITA17
 * Vaskivnyuk Mykhailo
 * 11.06.2017
...
/* ЗАВДАННЯ
Застосуй функцію malloc() для динамічного виділення пам'яті під масив структур:
1) створити структуру Club з наступними полями:
     name - назва клубу;
     сity - місто, яке представляє клуб;
...
3) в циклі заповнити масив стуркутр даними про клуби (використовуючи покажчик
