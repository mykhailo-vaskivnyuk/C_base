 ...
 * Частина 4. Вилучення елемента-вершини стеку.
 *----------------------------------------------------------------
 * ITA17
 * Vaskivnyuk Mykhailo
 * 25.06.2017
...
/* ЗАВДАННЯ
Перепишіть процедуру Pop() , використовуючи винятково синтаксис С
...
розіменовуйте, коректно "очистіть" пам'ять від видаленого вузла).
*/
